...
{   
    ...
    setSunLight()
    {
        this.sunLight = new THREE.DirectionalLight('#ffffff', 0.956)
    ...
    {
        this.worldMap = {}
        this.worldMap.texture = this.resources.items.worldSphereTexture_1;
        this.worldMap.texture = this.resources.items.worldSphereTexture_2;
        this.worldMap.texture.colorSpace = THREE.SRGBColorSpace;
    }
